...
@WebServlet("/AdminGetProlistCtrl")
public class AdminGetProlistCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(prolist != null) {
			...
			RequestDispatcher view = request.getRequestDispatcher("/prolist/adminGetProlist.jsp");
