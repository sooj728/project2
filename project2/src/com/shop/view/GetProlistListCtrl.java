...
@WebServlet("/GetProlistListCtrl")
public class GetProlistListCtrl extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher view = request.getRequestDispatcher("/prolist/getProlistList.jsp");
